...
public class LocalPlayerController : NetworkBehaviour
{
    ...
    //public unused_CharacterMovement CharaMovementComp => _charaMovement;
    ...
    //private void Awake()
    //{
    //    _charaMovement = GetComponent<unused_CharacterMovement>();
    ...
    //    //{
    //    //    GetComponent<PlayerBody>().CmdSetBodyColour(Color.red);
    //    //}
    //    // test
